                ...
                <div class="row margin">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">{{App\Lib\Utils::getFormattedNumber($drug->quantity)}} {{$drug->quantityType->drug_type}}</div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">{{App\Lib\Utils::getTimestamp($drug->created_at)}}</div>
                        </div>
                    </div>
                </div>
            </div>
