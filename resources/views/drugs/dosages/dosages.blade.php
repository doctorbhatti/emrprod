                ...
                <tbody>
                    @forelse($dosages as $dosage)
                        <tr>
                            <td>
                                {{ $dosage->description }}
                                <form action="{{ route('editDosage', ['id' => $dosage->id]) }}" id="dosage{{ $dosage->id }}"
                                    method="post" hidden>
                                    @csrf
                            ...
                            <td>
                                @can('edit', $frequency)
                                    <button class="btn btn-sm btn-primary"
                                        onclick="toggleForm('frequency{{ $frequency->id }}')">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                @endcan
                ...
                <tbody>
                    @forelse($periods as $period)
                        <tr>
                            <td>
                                {{ $period->description }}
                                <form action="{{ route('editPeriod', ['id' => $period->id]) }}" id="period{{ $period->id }}"
                                    method="post" hidden>
                                    @csrf
                                    <div class="input-group">
