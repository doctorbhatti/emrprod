...
<script>
    // Pass patient data and investigations from the backend to JavaScript
    const patient = @json($patient);
    const clinic = @json($patient->clinic); // Pass the clinic data to JavaScript
</script>
    ...
    <div class="card-body">
        ...
        <div class="tab-content" ng-app="HIS">
            <ul class="nav nav-tabs" role="tablist">
                @can('view', $patient)
                    <li class="nav-item">
                        <a class="nav-link @cannot('prescribeMedicine', $patient) active @endcannot" id="info-tab"
                            data-bs-toggle="tab" href="#info" role="tab" aria-controls="info">Info</a>
                    </li>
                @endcan
                ...
                @can('prescribeMedicine', $patient)
                    <li class="nav-item">
                        <a class="nav-link active" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                            aria-controls="profile">Prescribe Medicine</a>
                    </li>
                @endcan
            ...
            <div class="tab-content">
                <div class="tab-pane fade @cannot('prescribeMedicine', $patient) show active @endcannot" id="info"
