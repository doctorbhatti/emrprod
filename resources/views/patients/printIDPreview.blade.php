...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-6 col-md-offset-3 col-xs-12">
            <div class="panel panel-success" id="patientID">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <h4>
                                ...
                                @endif
                                @if($patient->nic)
                                    <small>{{ $patient->nic }}</small><br>
                                @endif
                                @if($patient->gender)
                                    <small>{{ $patient->gender }}</small><br>
                                @endif
                            </h4>
                            <div class="col-md-8 col-md-offset-4 col-xs-9 col-xs-offset-3 pull-left" id="barcode"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row margin-top container-fluid no-print">
        <div class="col-md-2 col-md-offset-3">
            <a href="{{ route('patient', ['id' => $patient->id]) }}" class="btn btn-danger" aria-label="Back to Patient">
                <i class="fa fa-chevron-left" aria-hidden="true"></i> Back to Patient
            </a>
        </div>
        <div class="col-md-2 col-md-offset-2">
            <button class="btn btn-success pull-right" onclick="window.print()" aria-label="Print">
